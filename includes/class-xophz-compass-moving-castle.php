...
class Xophz_Compass_Moving_Castle extends Xophz_Compass_Plugin_Base {
	...
	public function __construct( ?string $param1 = null, ?string $version = null, string $param3 = '' ) {
		if ( null === $param1 ) {
			$file = dirname( __DIR__ ) . '/xophz-compass-moving-castle.php';
			$ver  = defined( 'XOPHZ_COMPASS_MOVING_CASTLE_VERSION' ) ? XOPHZ_COMPASS_MOVING_CASTLE_VERSION : '1.0.0';
			parent::__construct( $file, $ver, 'xophz-compass-moving-castle' );
		} else {
